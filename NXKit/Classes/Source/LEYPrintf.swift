...
/*
 打印普通日志
 */
public func LEYPrint<T>(_ items:T ,file:String = #file,method: String = #function,line: Int = #line) {
    #if DEBUG
...
/*
 打印错误日志
 */
public func LEYPrintError<T>(_ items:T ,file:String = #file,method: String = #function,line: Int = #line) {
    #if DEBUG
    let format = "YYYY-MM-dd HH:mm:ss SSS"
    let time = getCurrentTime(format)
    print("\((file as NSString).lastPathComponent)[\(line)],\(method):-----💔💔💔💔💔💔💔💔\(time)-----\n\(items)\n")
...
/*
 打印Warn日志
 */
public func LEYPrintWarm<T>(_ items:T ,file:String = #file,method: String = #function,line: Int = #line) {
    #if DEBUG
    let format = "YYYY-MM-dd HH:mm:ss SSS"
    let time = getCurrentTime(format)
    print("\((file as NSString).lastPathComponent)[\(line)],\(method):-----💛💛💛💛💛💛💛💛\(time)-----\n\(items)\n")
...
/*
 打印网络日志---成功
 */
public func LEYPrintHttpSuccess<T>(_ items:T ,file:String = #file,method: String = #function,line: Int = #line) {
    #if DEBUG
    let format = "YYYY-MM-dd HH:mm:ss SSS"
    let time = getCurrentTime(format)
    print("\((file as NSString).lastPathComponent)[\(line)],\(method):-----🌍💚🌍💚🌍💚🌍💚\(time)-----\n\(items)\n")
...
/*
 打印网络日志---失败
 */
public func LEYPrintHttpFailed<T>(_ items:T ,file:String = #file,method: String = #function,line: Int = #line) {
    #if DEBUG
    let format = "YYYY-MM-dd HH:mm:ss SSS"
    let time = getCurrentTime(format)
    print("\((file as NSString).lastPathComponent)[\(line)],\(method):-----🌍💔🌍💔🌍💔🌍💔\(time)-----\n\(items)\n")
 ...
 */
public func LEYPrintTmpTime(_ des:String) {
    let format = "YYYY-MM-dd HH:mm:ss SSS"
    let time = getCurrentTime(format)
