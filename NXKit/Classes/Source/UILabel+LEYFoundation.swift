...
extension UILabel {
    ...
    public convenience init(frame: CGRect,
                            ...
                            lineSpacing:CGFloat,
                            completion:LEYApp.Completion<String, NSMutableParagraphStyle>? = nil) {
...
extension UILabel {
    ...
    public func addBottomColorView(color: UIColor = LEYApp.mainColor.withAlphaComponent(0.85), height: CGFloat = 7) {
        guard let str = self.text else {
            return
        }
 
        
        let width = str.stringWidth(font: self.font, size: CGSize(width: LEYDevice.width, height: 50))
