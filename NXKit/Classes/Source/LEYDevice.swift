...
open class LEYDevice {
    ...
    static public var isXDisplay: Bool {
        return LEYDevice.insets.bottom > 0.0
    }
    
    //根据isXDisplay处理UI常量信息
    static public var topOffset : CGFloat {
        return LEYDevice.insets.top + 44.0
    }
    
    static public var bottomOffset : CGFloat {
        return LEYDevice.insets.bottom
    }
    ...
    public static var is320x480x1 = LEYDevice.Typed(width: 320, height: 480, scale: 1, inches: [3.5]) ///[iPhone,iPhone3GS]
    public static var is320x480x2 = LEYDevice.Typed(width: 320, height: 480, scale: 2, inches: [3.5]) ///[iPhone4,iPhone4S]
    public static var is320x568x2 = LEYDevice.Typed(width: 320, height: 568, scale: 2, inches: [4.0]) ///[iPhone5,iPhone5c,iPhone5S,iPhoneSE1]
        
    public static var is375x667x2 = LEYDevice.Typed(width: 375, height: 667, scale: 2, inches: [4.7]) ///[iPhone6,iPhone6s,iPhone7,iPhone8,iPhoneSE2]
    public static var is375x812x3 = LEYDevice.Typed(width: 375, height: 812, scale: 3, inches: [5.4,5.8]) ///[iPhone12mini],[iPhoneX,iPhoneXs,iPhone11Pro]
    
    public static var is390x844x3 = LEYDevice.Typed(width: 390, height: 844, scale: 3, inches: [6.1]) ///[iPhone12,iPhone12Pro]
    
    public static var is414x736x3 = LEYDevice.Typed(width: 414, height: 736, scale: 3, inches: [5.5]) ///[iPhone6Plus,iPhone6sPlus,iPhone7Plus,iPhone8Plus]
    public static var is414x896x2 = LEYDevice.Typed(width: 414, height: 896, scale: 2, inches: [6.1]) ///[iPhoneXr,iPhone11]
    public static var is414x896x3 = LEYDevice.Typed(width: 414, height: 896, scale: 3, inches: [6.5]) ///[iPhoneXs max,iPhone11ProMax]
    
    public static var is428x926x3 = LEYDevice.Typed(width: 428, height: 926, scale: 3, inches: [6.7]) ///[iPhone12ProMax]
}
