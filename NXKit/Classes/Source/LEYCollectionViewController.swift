//
//  LEYCollectionViewController.swift
//  NXFoundation
//
...
open class LEYCollectionViewController: LEYViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {

    public var collectionView : LEYCollectionView? = nil
    public let collectionWrapper = LEYCollectionWrapper()
    ...
    override open func viewDidLoad() {
        ...
        self.collectionView = LEYCollectionView(frame: self.contentView.bounds)
        self.collectionView?.autoresizingMask = [.flexibleWidth, .flexibleHeight]
        self.collectionView?.backgroundColor = LEYApp.collectionViewBackgroundColor
