...
open class LEYAnimationView: LEYImageView {
    //动画时长
    ...
    override open func setupSubviews() {
        ...
        self.image = LEYApp.image(named:"uiapp_overlay.png")
    }
...
open class LEYAnimationWrappedView: LEYView {
    //转圈的视图
    open var animationView = LEYAnimationView()
    ...
    override open func setupSubviews() {
        ...
        self.animationView.image = LEYApp.image(named:"uiapp_overlay.png")
