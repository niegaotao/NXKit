...
open class NXFooterView: NXLCRView<NXButton, NXButton, NXButton> {
    override open func setupSubviews() {
        ...
        centerView.titleLabel?.font = NXUI.font(15)
