...
open class NXAbstract: NXItem {
    ...
    override public init(value: [String: Any]?, completion: NXKit.Completion<NXAbstract>?) {
    ...
    public convenience init(title: String, value: [String: Any]?, completion: NXKit.Completion<NXAbstract>?) {
        ...
        size = CGSize(width: NXKit.width, height: NXKit.Association.size.height)
        self.title.value = title
        self.title.frame = CGRect(x: 16, y: 0, width: NXKit.width - 32, height: size.height)
