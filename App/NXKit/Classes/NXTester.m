...
//@end
//
//@implementation NSKVONotifying_NXPerson
//
//
//@end
...
+ (NXTester *)center {
    static NXTester *__center;
    static dispatch_once_t __once;
    dispatch_once(&__once, ^{
        __center = [[NXTester alloc] init];
    });
    return __center;
}
...
- (void)debug {
    //NXTester.test()
    //NXTester.testPtr()
    //NXTester.center().testLock();
    //NXTester.center().testStringCopy();
    //NXTester.center().testDictionaryCopy();
...
//
//- (void)testClass{
//    NXStudent *worker = [[NXStudent alloc] init];
//    worker.name = @"__Null";
//    worker.college = @"工程学院";
//    NSMutableDictionary *dicValue = [NXApi descriptionClass:worker.class];
//    NSLog(@"%@", dicValue);
//}
//
//
